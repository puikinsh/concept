    ...
    inbox: [
      {
        ...
        preview:
          'Hi team, I wanted to reach out regarding our upcoming Q4 product launch strategy meeting...',
        time: '2:30 PM',
        starred: true,
        unread: true,
        attachments: true,
      ...
      },
      {
        ...
        preview:
          'Please find attached the updated budget figures for Q4. We need to discuss the marketing allocation...',
        time: '11:45 AM',
        starred: false,
        unread: true,
        attachments: true,
      ...
      },
      {
        ...
        preview:
          "I've reviewed the mockups and they look great! I have a few suggestions about the color scheme...",
        time: '10:30 AM',
        starred: false,
        unread: false,
        attachments: false,
      ...
      },
      {
        ...
        preview:
          "Mark your calendars! Our annual team building event is scheduled for next month. We'll be...",
        time: 'Yesterday',
        starred: true,
        unread: false,
        attachments: false,
      ...
      },
      {
        ...
        preview:
          'The API documentation has been updated with the new endpoints. Please review section 3.2 for...',
        time: 'Yesterday',
        starred: false,
        unread: false,
        attachments: true,
    ...
    sent: [
      {
        ...
        preview:
          "Thanks for the update John. I've reviewed the documents and have some feedback...",
        time: '1:15 PM',
        starred: false,
        unread: false,
        attachments: false,
    ...
    drafts: [
      {
        ...
        preview:
          "Hi team, I've been thinking about our next campaign and wanted to share some initial ideas...",
        time: 'Draft',
        starred: false,
        unread: false,
        attachments: false,
